...
llenargrid()
{
  ...
  try{
      ...
      axios.get('https://86efe438b3d3.ngrok.io/cursos')
     .then(res => {
        this.setState({
           datagrid: res.data,
...
llenargrid2()
{
  ...
  try{
      ...
      axios.get('https://86efe438b3d3.ngrok.io/alumnos')
     .then(res => {
        this.setState({
           datagrid: res.data,
           longData: res.data.length
...
async actividad1()
{
   ...
   await  axios.get('https://86efe438b3d3.ngrok.io/cursos/'+pre)
     .then(res => {
        this.setState({
           namecurso: res.data
         });
   ...
   await axios.get('https://86efe438b3d3.ngrok.io/alumnos/'+pre2)
     .then(res => {
        this.setState({
           namealumno: res.data
         });
...
fetch("https://86efe438b3d3.ngrok.io/alumnos/"+pre2+'/notas', requestOptions)
...
fetch("https://86efe438b3d3.ngrok.io/cursos/"+pre+'/actividad/'+c, requestOptions)
  .then(response => response.json())
...
fetch("https://86efe438b3d3.ngrok.io/cursos/"+pre+'/alumnos/'+pre2, requestOptions)
  .then(response => response.json())
  .then(result => console.log(result))
  .then(
  console.log("paso4")
