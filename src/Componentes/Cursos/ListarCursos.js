...
uri='https://86efe438b3d3.ngrok.io/cursos';
...
if(rol=="catedratico")
{
 ...
 await axios.get('https://86efe438b3d3.ngrok.io/catedraticos/'+userid+'/initial')
      .then(res => {
        this.setState({
...
if(s>0)
{
  uri='https://86efe438b3d3.ngrok.io/catedraticos/'+s+'/cursos';
...
this.setState({datosCursos:[]});
 ...
 await  axios.get('https://86efe438b3d3.ngrok.io/cursos/'+id)
      .then(res => {
        this.setState({
           datagrid: res.data,
...
var c=datagrid.prerequisito;
 ...
 if(c>0)
{
  axios.get('https://86efe438b3d3.ngrok.io/cursos/'+c)
      .then(res => {
        this.setState({
...
var hj;
 ...
 axios.get('https://86efe438b3d3.ngrok.io/cursos/'+id+'/notas')
      .then(res => {
        this.setState({
...
editarNota(id)
{
  ...
  axios.get('https://86efe438b3d3.ngrok.io/notas/'+id)
      .then(res => {
        this.setState({
          activ: res.data,
         });
...
else
{
  ...
  axios.get('https://86efe438b3d3.ngrok.io/notas/'+xc)
      .then(res => {
        this.setState({
          activ2: res.data,
         });
...
fetch("https://86efe438b3d3.ngrok.io/alumnos/"+activ2[0].alumno+'/notas/'+xc, requestOptions)
